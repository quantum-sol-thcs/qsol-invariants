...
Version: 1.0
Status: Canonical
Governs: All contributors, maintainers, and participants in QSol.llc  repositories
...
focused on mathematical and architectural correctness

The goal is to protect the invariant canon and maintain a productive environment for all contributors.
...
Follow the Contribution Guidelines and Maintainers Guide
...
Ignoring or dismissing the QSOL Engineering Doctrine
...
Reports will be reviewed promptly, professionally, and confidentially.
...
Reverting non‑canonical changes

Enforcement decisions are final and guided by:

the QSOL Engineering Doctrine

the Maintainers Guide

the need to preserve canonical integrity
...
all official QSol.llc  communication channels
